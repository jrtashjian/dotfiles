---
name: unslop
description: Cut AI tells from any writing. Use when writing or editing prose, docs, comments, commit messages, PR descriptions, or user-facing copy. Always apply before finishing written output.
---

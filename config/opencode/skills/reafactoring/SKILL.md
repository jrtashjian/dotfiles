---
name: refactoring
description: Enforces Martin Fowler's Refactoring discipline: small, behavior-preserving improvements to structure, duplication, names, and readability without mixing in functional changes.
---

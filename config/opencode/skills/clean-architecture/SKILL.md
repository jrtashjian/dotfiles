...
description: Enforces mandatory Clean Architecture rules from Robert C. Martin for dependency direction, layer separation, business rules independence, and replaceable details.
---
